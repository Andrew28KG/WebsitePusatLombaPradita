...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($fileSize > 409600) {
        ...
        header("refresh:3;url=TambahLomba.php");
        exit;
    }
    ...
    $sql = "INSERT INTO lomba (Waktu, Tanggal_Pendaftaran, Penyelengaraan, Tema, Deadline_Pendaftaran, Lokasi, Nama_kegiatan, Poster, NI, Link, Syarat, Prodi, Status) 
    VALUES ('$Waktu', '$Tanggal_Pendaftaran', '$Penyelengaraan', '$Tema', '$Deadline_Pendaftaran', '$Lokasi', '$Nama_kegiatan', '$PosterData', '$NI', '$Link', '$Syarat', '$Prodi', 1)";
    ...
    echo "<meta http-equiv=refresh content=3;URL='/admin/HomePageAdmin.php'>";
}
?>
